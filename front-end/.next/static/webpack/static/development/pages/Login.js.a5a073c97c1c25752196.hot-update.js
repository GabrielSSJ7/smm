    ...
    FB.login(function (response) {
      if (response.authResponse) {
        ...
        FB.api(url, function (response) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("".concat(_types__WEBPACK_IMPORTED_MODULE_0__["actionTypes"].URL, "signin-with-facebook"), data).then(function (res) {
            localStorage.setItem("authToken", res.data.token);
...
//# sourceMappingURL=Login.js.a5a073c97c1c25752196.hot-update.js.map