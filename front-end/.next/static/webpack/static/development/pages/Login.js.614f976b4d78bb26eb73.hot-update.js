    ...
    FB.login(function (response) {
      if (response.authResponse) {
        ...
        FB.api(url, function (response) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("".concat(URL, "signin-with-facebook"), data).then(function (res) {
            localStorage.setItem("authToken", res.data.token);
...
//# sourceMappingURL=Login.js.614f976b4d78bb26eb73.hot-update.js.map